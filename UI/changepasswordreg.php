...
$sql->bindValue(':accID',$_SESSION['accountIDreg']);
$sql->execute();
...
if(isset($_POST['change'])){
    ...
    if($old == $accPW && $new == $con){
        ...
        $pwUpdate->bindValue(':acID',$_SESSION['accountIDreg']);
        $pwUpdate->execute(); 
        $isChanged = true;
        header("refresh:2; url = regMenu.php");
...
<body>
    ...
    <div class="btncontainer">
        ...
        <a class="navtop" href="changepasswordreg.php"> Change Password </a>
    </div>
